...
average_Democrat_record = find_average_record({'Kennedy', 'Byrd', 'Clinton', 'Baucus', 'Reid', 'Bingaman', 'Salazar', 'Levin',
    'Landrieu', 'Conrad', 'Biden', 'Feinstein', 'Bayh', 'Durbin', 'Nelson1', 'Nelson2',
    'Obama', 'Feingold', 'Inouye', 'Dodd', 'Mikulski', 'Dayton', 'Kerry', 'Schumer',
    'Cantwell', 'Lautenberg', 'Akaka', 'Pryor', 'Murray', 'Rockefeller', 'Harkin',
    'Dorgan', 'Lincoln', 'Johnson', 'Reed', 'Wyden', 'Sarbanes', 'Kohl', 'Lieberman',
    'Leahy', 'Boxer', 'Stabenow', 'Carper'}, create_voting_dict()) # (give the vector)
