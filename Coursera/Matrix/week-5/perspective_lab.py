...
D = {('y3', 'x3'), ('y3', 'x1'), ('y1', 'x2'), ('y2', 'x1'), ('y2', 'x2'), ('y1', 'x3'), ('y1', 'x1'), ('y3', 'x2'), ('y2', 'x3')}
...
def make_nine_equations(corners):
    ...
    >>> for x in make_nine_equations(((12,13),(14,15),(16,17),(18,19))): print(x)
    ...
    ---------------------------------------------------------------------------------------------------------------------
     ...
     ('y1', 'x1') ('y1', 'x2') ('y1', 'x3') ('y2', 'x1') ('y2', 'x2') ('y2', 'x3') ('y3', 'x1') ('y3', 'x2') ('y3', 'x3')
    ---------------------------------------------------------------------------------------------------------------------
                0            0            0          -14          -15           -1           14           15            1
    
     ('y1', 'x1') ('y1', 'x2') ('y1', 'x3') ('y2', 'x1') ('y2', 'x2') ('y2', 'x3') ('y3', 'x1') ('y3', 'x2') ('y3', 'x3')
    ---------------------------------------------------------------------------------------------------------------------
              -16          -17           -1            0            0            0           16           17            1
    ...
    ---------------------------------------------------------------------------------------------------------------------
     ...
     ('y1', 'x1') ('y1', 'x2') ('y1', 'x3') ('y2', 'x1') ('y2', 'x2') ('y2', 'x3') ('y3', 'x1') ('y3', 'x2') ('y3', 'x3')
    ---------------------------------------------------------------------------------------------------------------------
              -18          -19           -1            0            0            0           18           19            1
    
     ('y1', 'x1') ('y1', 'x2') ('y1', 'x3') ('y2', 'x1') ('y2', 'x2') ('y2', 'x3') ('y3', 'x1') ('y3', 'x2') ('y3', 'x3')
    ---------------------------------------------------------------------------------------------------------------------
                0            0            0          -18          -19           -1           18           19            1
...
H = Mat(({'y1','y2','y3'},{'x1','x2','x3'}),{(x1,x2):y for (x1,x2),y in hvec.f.items()})
...
def mat_move2board(Y):
    ...
    board_y_cols = {x:move2board(y_cols[x]) for x in y_cols.keys()}
    return coldict2mat(board_y_cols)
